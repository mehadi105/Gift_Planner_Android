...
public class UpcomingOccasionsAdapter extends RecyclerView.Adapter<UpcomingOccasionsAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if ("custom".equals(eventType)) {
            holder.tvEventType.setText("Custom: " + (occasion.getGiftIdea() != null ? occasion.getGiftIdea() : ""));
        } else {
